/* global webkitRTCPeerConnection, mozRTCPeerConnection, RTCRtpTransceiver */
'use strict';
...
function getActiveIceCandidatePairStats(peerConnection, options) {
  ...
  if (typeof options.testForChrome !== 'undefined'
    ...
    || typeof options.testForSafari  !== 'undefined'
    || guessBrowser() === 'safari') {
  ...
  if (typeof options.testForSafari  !== 'undefined'
    ...
    return Promise.reject(new Error(
      ['getStats() is not supported on this version of Safari',
       'due to this bug: https://bugs.webkit.org/show_bug.cgi?id=192601'].join(' ')));
  }
  return Promise.reject(new Error('RTCPeerConnection#getStats() not supported'));
}
