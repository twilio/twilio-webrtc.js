...
function ChromeRTCPeerConnection(configuration) {
  ...
  Object.defineProperties(this, {
    ...
    ondatachannel: {
      ...
      set: function(_ondatachannel) {
        if (ondatachannel) {
          this.removeEventListener('datachannel', ondatachannel);
        }

        if (typeof _ondatachannel === 'function') {
          ondatachannel = _ondatachannel;
          this.addEventListener('datachannel', ondatachannel);
        } else {
          ondatachannel = null;
        }
      }
