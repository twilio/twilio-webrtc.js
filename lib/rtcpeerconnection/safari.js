...
function SafariRTCPeerConnection(configuration) {
  ...
  Object.defineProperties(this, {
    ...
    // NOTE(syerrapragada): There is small time frame when remote offer is applied
    // but _pendingRemoteOffer is not cleared causing an issue in OrderedTrackMatcher
    // in twilio-video.js.
    _isPendingRemoteOfferApplied: {
      value: true,
      writable: true
    },
    ...
    remoteDescription: {
      ...
      get: function() {
        return this._isClosed
          ? null
          : this._isPendingRemoteOfferApplied
...
SafariRTCPeerConnection.prototype.createAnswer = function createAnswer(options) {
  ...
  if (this._pendingRemoteOffer) {
    self._isPendingRemoteOfferApplied = true;
...
function setDescription(peerConnection, local, description) {
  function setPendingLocalOffer(offer) {
    if (local) {
      ...
      peerConnection._isPendingRemoteOfferApplied = false;
    }
  }
