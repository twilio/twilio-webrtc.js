...
// [https://github.com/webrtc/adapter/issues/714] has been filed, and this
// shim will be removed once it is addressed.
SafariRTCPeerConnection.prototype.addTrack = function addTrack() {
  var args = [].slice.call(arguments);
  var track = args[0];
  var sender = this._peerConnection.addTrack.apply(this._peerConnection, args);
  return sender || this._peerConnection.getSenders().find(function(sender) {
...
//
SafariRTCPeerConnection.prototype.removeTrack = function removeTrack() {};
