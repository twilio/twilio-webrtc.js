...
function SafariRTCPeerConnection(configuration) {
  ...
  // NOTE(syerrapragada): When the OrderedTrackMatcher in twilio-video.js accesses the underlying
  // RTCPeerConnection's remoteDescription, the _pendingRemoteOffer is used instead of the actual
  // remote RTCSessionDescription as it is not set to null yet.
