  ...
  function clearPendingLocalOffer() {
    if (local) {
      ...
      peerConnection._nonNegotiatedTracks.forEach(function(track) {
        // NOTE(syerrapragada): otalk/peerconnection-shim transceiver is not a true
        // transceiver object. track property is supposed to be on sender or receiver
        // and not in transceiver.
